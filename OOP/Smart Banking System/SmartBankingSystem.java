...
public class SmartBankingSystem {
            ...
            try {
                switch (choice) {
                    ...
                    case 2:
                        ...
                        BankAccount depAcc = findAccount(
                                sc.nextInt());
                        System.out.print(
                    ...
                    case 4:
                        ...
                        BankAccount srcAcc = findAccount(
                                sc.nextInt());
                        verifyPin(srcAcc);
                        System.out.print(
                                "Enter receiver account number: ");
                        BankAccount recAcc = findAccount(
                                sc.nextInt());
                        System.out.print(
                    ...
                    case 5:
                        System.out.print(
                                "Enter account number: ");
                        BankAccount balAcc = findAccount(
                                sc.nextInt());
                        balAcc.checkBalance();
                        break;
                    ...
                    case 6:
                        System.out.print(
                                "Enter account number: ");
                        BankAccount txAcc = findAccount(
                                sc.nextInt());
                        System.out.println(
                                "\n--- Transaction History for Account "
                                        + txAcc.getAccountNumber()
                                        + " ---");
                        if (txAcc.getTransactions()
                                .isEmpty()) {
                            System.out.println(
                                    "No transactions yet.");
                        } else {
                    ...
                    case 7:
                        ...
                        BankAccount clAcc = findAccount(
                                sc.nextInt());
                        verifyPin(clAcc);
                        System.out.print(
                                "Are you sure you want to close account "
                                        + clAcc.getAccountNumber()
                                        + "? (yes/no): ");
                    ...
                    case 8:
                        System.out.print(
                                "Enter account number: ");
                        BankAccount pinAcc = findAccount(
                                sc.nextInt());
                        System.out.print(
                                "Enter current PIN: ");
    ...
    private static void openAccount()
        ...
        if (initialDeposit < minDeposit) {
            throw new InvalidAmountException(
                    accountType
                            + " requires minimum initial deposit of "
                            + minDeposit);
        }
        ...
        BankAccount newAccount = new BankAccount(
                name, initialDeposit, accountType, pin);
    ...
    private static void verifyPin(BankAccount account)
        ...
        throw new SecurityException(
                "Account "
                        + account.getAccountNumber()
                        + " locked after 3 failed PIN attempts.");
    }
}
